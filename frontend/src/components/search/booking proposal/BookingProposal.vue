  ...
  <div>
        ...
        <el-row style="margin-top: 25px">
          ...
          <el-row>
            ...
            <el-row style="margin-top: 10px">
              <span class="demonstration" style="margin-left: 59px; font-size: 80%">Proposal Id</span>
              <el-input size="mini" v-model="criteria.proship.bookingProposalId" placeholder="Proposal ID"
                        class="shortInput" style="margin-left: 15px;width: 37%"
                        @change="handleBookingProposalIdChange"></el-input>
            </el-row>
            <el-row style="margin-top: 10px">
    ...
    <el-row>
      ...
      <el-col :span="5" :offset="7">
        ...
        <el-button style="margin: auto" @click="displayBookingProposal">
          Display BookingProposal({{result.bookingProposalIdList.length}})</el-button>
      </el-col>
      <el-col :span="2">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleTypeChange(){},
      reset(){},
      displayBookingProposal(){},
      handleRecruiterChange(){},
      handleAccountManagerChange(){},
      handleGigIdChange(){},
      handleBookingProposalIdChange(){},
      handleJobIdChange(){},
      handleCompanyChange(){},
